export default function Footer() {
    return (
        <footer className="bg-[#020202] text-white py-16 border-t border-white/5">
            <div className="max-w-6xl mx-auto px-6">
                <div className="grid md:grid-cols-2 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <dl className="grid grid-cols-[100px_1fr] gap-y-4 text-sm text-gray-400 font-light">
                            
                            <dt className="font-medium text-gray-500">社名</dt>
                            <dd>合同会社O2plusNO</dd>
                            ...
                            <dt className="font-medium text-gray-500">創業</dt>
                            <dd>2017年10月11日</dd>

                            <dt className="font-medium text-gray-500">資本金</dt>
                            ...
                            <dt className="font-medium text-gray-500">主要取引銀行</dt>
                            <dd>みずほ銀行</dd>

                            <dt className="font-medium text-gray-500">許可証</dt>
